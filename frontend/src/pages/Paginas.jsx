export default function Paginado ({goToNextPage, goToPreviousPage, paginas,currentPage ,elementsByPage,allElemtns}){
    ...
    return (
        <div className="paginacion">
                ...
                { currentPage -1 > 0 ?
                     <svg xmlns="http://www.w3.org/2000/svg" onClick={goToPreviousPage} className="icon icon-tabler icon-tabler-arrow-big-left" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="#f28b12" fill="none" strokeLinecap="round" strokeLinejoin="round">
              ...
              {currentPage>=3 ?  <button onClick={() => paginas(currentPage-2)}>{currentPage-2}</button> : null}
               ...
               {currentPage<=pageNumber.length - 2 ? <button onClick={() => paginas(currentPage+2)}>{currentPage+2}</button>: null}
                ...
                { currentPage < page ?
                  <svg xmlns="http://www.w3.org/2000/svg" onClick={goToNextPage} className="icon icon-tabler icon-tabler-arrow-big-right" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="#f28b12" fill="none" strokeLinecap="round" strokeLinejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
